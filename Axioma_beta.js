  ...
  const statusNotToCheck1 = document.querySelector(
    ...
    if (
      ...
      orders.forEach((el, index) => {
        ...
        if (document.body.innerText.includes("Другие заказы")) {
        let needToOther = el.querySelector(
          "table.inner > tbody > tr > td > table > tbody > tr > td.SkladBlock > table > tbody > tr:last-child > td.right.nobreak"
        );
        ...
        if (needToOther) {
         ...
         if (
           ...
           console.log(needCountValue)
           console.log(stockRemainValue)
           console.log(needToOtherValue)
           if (btnsgroup2 !== null) {
      ...
      orders.forEach((el, index) => {
        ...
        if (needToOther) {
         ...
         console.log('You obosralsa без файлов')
          needCountValue = Number(
            needCount.innerText.replace(/\s|\&nbsp;/g, "")
          );
          stockRemainValue = Number(
