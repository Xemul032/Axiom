...
newFinStop();
    ...
    function injectCalculator(targetElement, formulaType) {
        ...
        // Блок результатов (50% ширины фрейма)
        ...
        // Блок доступности (на всю ширину под основным контентом)
        ...
        availabilityDiv.innerHTML = `
            ...
            <!-- Методы печати и изготовления в две колонки -->
            ...
            <!-- Сообщение о недоступности (во всю ширину) -->
            ...
            <!-- Максимальные размеры (во всю ширину, три блока) -->
        ...
        // 🔒 Блокируем поля ширины и высоты СРАЗУ при создании калькулятора
        lockDimensionFields();
        ...
        // === Функция вычисления максимального значения относительно границ ПЕЧАТИ ===
